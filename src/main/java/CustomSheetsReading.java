...
public class CustomSheetsReading {
    private static final String APPLICATION_NAME = "Google Sheets API Java With My Custom Sheets";
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        ...
        final String spreadsheetId = "1WPHRacPbpy3GXvOxbzGLPtqgOt9bb_Y1LQRLvbeab54";
        final String range = "Record!A2:C";
